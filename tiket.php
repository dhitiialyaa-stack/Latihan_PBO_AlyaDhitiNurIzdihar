...
abstract class Tiket {
    // Properti terenkapsulasi (protected) sesuai kolom tabel database
    protected $id_tiket;
    protected $nama_film;
    ...
    // Constructor untuk memetakan data secara otomatis dari database
    ...
    // Metode Abstrak (Wajib diimplementasikan ulang di kelas anak)
    abstract public function hitungTotalHarga();
    abstract public function tampilkanInfoFasilitas();

    // Getter (Opsional - berguna jika ingin mengakses nilai di luar kelas/objek)
